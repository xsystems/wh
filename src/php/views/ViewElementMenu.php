...
class ViewElementMenu implements IViewElement, IViewAttributes
{
	...
	public function init()
	{
		...
		$homeLink->setAttribute("href", "?action=home");
		...
		$calendarLink->setAttribute("href", "?action=calendar");
		...
		$clubmagazineLink->setAttribute("href", "?action=gallery&type=clubmagazine");
		...
		$imagesLink->setAttribute("href", "?action=gallery&type=image");
		...
		$videosLink->setAttribute("href", "?action=gallery&type=video");
		...
		$readLink->setAttribute("href", "?action=vertel");
		...
		$writeLink->setAttribute("href", "?action=boodschap");
		...
		$organisationLink->setAttribute("href", "?action=organisation");
		...
		$locationLink->setAttribute("href", "?action=location");
		...
		$costsLink->setAttribute("href", "?action=costs");
		...
		$meteorologyLink->setAttribute("href", "?action=meteorology");
		...
		$canoetoursLink->setAttribute("href", "?action=canoetours");
