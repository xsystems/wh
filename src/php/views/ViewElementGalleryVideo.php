...
class ViewElementGalleryVideo extends ViewElementGallery
{
	...
	{		
		...
		$script->setAttribute("src", "/src/js/setup_videojs.js");	
		
		$pageNumber = 0;
		$videoID = 0;
		$sg = new SimpleGalleryVideo($this->itemsPerPage, $this->screenshortSecond, $this->videoDirURL, $this->videoDirPath);    	
