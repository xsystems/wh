...
class ViewElementHome implements IViewElement, IViewAttributes
{
    private $domElement;
	...
	public function init()
	{
		...
		$domDocumentFragment->appendXML( "  <article class='article_home'>
                                            ...
                                            <br/><br/>
                                            Het verenigingsgebouw met botenloods ligt aan de Wennetjes<wbr> </wbr>sloot achter het laatste parkeerterrein van schaatscentrum de Uithof. Je kunt dit bereiken via de Jaap Edenweg (<a href='?action=location' title='Adresgegevens'>zie platte<wbr> </wbr>grond</a>).
                                            <br/>
