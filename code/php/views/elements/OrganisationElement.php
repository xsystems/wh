...
class OrganisationElement implements ITemplateElement, ITemplateAttributes
{
	...
	public function createTemplateElement()
	{
		...
		$organisationElement = $domDocument->createElementNS(self::namespaceURI, "div");			
		$organisationElement->setAttribute("class", $this->rootElementClass);
		...
		$organisationElement->appendChild($domDocumentFragment);			
