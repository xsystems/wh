...
require_once("../lib/SimplePDFGallery.php");

class ClubMagazineGalleryElement extends GalleryElement
{
	...
	public function init()
	{
        ...
        if($this->clubmagazineDirURL != null)
        {
		    ...
		    $pageNumber = 0;
		    $sg = new SimplePDFGallery($this->clubmagazinesPerPage, $this->clubmagazineDirURL, $this->clubmagazineDirPath, $this->thumbnailDirURL, $this->thumbnailDirPath);    	
