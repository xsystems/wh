...
class BoodschapElement implements ITemplateElement, ITemplateAttributes
{
	...
	public function createTemplateElement()
	{
		...
		$boodschapElement = $domDocument->createElementNS(self::namespaceURI, "div");			
		$boodschapElement->setAttribute("class", $this->rootElementClass);
		...
		$boodschapElement->appendChild($domDocumentFragment);			
		
		return $boodschapElement;
	}
}
?>
